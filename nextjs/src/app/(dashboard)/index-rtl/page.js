...
export default function Page() {
  useEffect(() => {
    ...
    const oldLang = htmlElement.getAttribute("lang");
    ...
    rtlLink.href = "/assets/css/styles-rtl.css";
    ...
    return () => {
      // Revert attributes
      if (oldDir) {
        htmlElement.setAttribute("dir", oldDir);
      } else {
      ...
      const linkToRemove = document.getElementById("rtl-stylesheet");
      if (linkToRemove) {
        linkToRemove.remove();
      }
    };
        ...
        <div className="row">
          ...
          <div className="col-xxl-12 mb-3">
            <div className="alert alert alert-danger alert-dismissible fade show" role="alert">
              <strong>RTL Mode Instructions:</strong>
              To enable Right-to-Left (RTL) layout, please follow these 2 steps:
              <ol className="mb-0 mt-1">
                <li>Add <code>&lt;html lang="ar" dir="rtl"&gt;</code> to the page.</li>
                <li>Include <code>assets/css/styles-rtl.css</code> inside the <code>&lt;head&gt;</code> section.</li>
              </ol>
